    ...
    <div class="container py-5">
        <div class="card shadow-sm border-0 rounded-4">
            <div class="card-header text-white rounded-top-4"
                ...
                <h5 class="mb-0 fw-bold">✏️ Edit Pelanggan</h5>
            </div>
...
<style>
    ...
    .status-select {
    width: 100%;               /* Full lebar form */
    height: 60px;              /* Lebih tinggi */
    font-size: 1.1rem;         /* Huruf sedikit besar */
    padding: 0.75rem 1rem;     /* Ruang dalam */
    border: 1.8px solid #D1D5DB;
    transition: 0.3s ease;
    }

.status-select:focus {
    border-color: #3F51B5;     /* Warna biru elegan */
