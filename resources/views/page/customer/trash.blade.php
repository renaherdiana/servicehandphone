...
<div class="content-wrapper" style="background-color:#F5F5F5; min-height: 100vh;">
  <div class="container py-4">
    ...
    <div class="mb-4 d-flex justify-content-between align-items-center">
      <h4 class="fw-bold text-primary mb-0">🗑️ Trash Pelanggan</h4>
      <a href="{{ route('customer.index') }}" class="btn btn-secondary rounded-3 shadow-sm">
    ...
    <div class="card shadow-sm border-0 rounded-4">
      <div class="card-header py-3 px-4" 
        ...
        <h5 class="mb-0 fw-bold">👥 Data Pelanggan yang Dihapus</h5>
      </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  {{ \Carbon\Carbon::parse($customer->deleted_at)->translatedFormat('d F Y, H:i') }}
                </td>
