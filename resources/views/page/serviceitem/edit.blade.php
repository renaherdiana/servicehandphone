  ...
  <div class="container py-5">
    <div class="card shadow-sm border-0 rounded-4">
      <div class="card-header text-white rounded-top-4"
        ...
        <h5 class="mb-0 fw-bold">Edit Item Servis</h5>
      </div>

      <div class="card-body p-5">
        <form method="POST" action="{{ route('service.item.update', $serviceItem->id) }}">
          @csrf
          @method('PUT')
          <div class="row g-4">
            <div class="col-12">
              ...
              <div class="mb-4">
                ...
                <option value="1" {{ old('is_active', $serviceItem->is_active) == 1 ? 'selected' : '' }}>Active</option>
                <option value="0" {{ old('is_active', $serviceItem->is_active) == 0 ? 'selected' : '' }}>Non Active</option>
              </select>
              </div>
...
<style>
  ...
  .form-input-large {
    height: 50px;       /* bikin input lebih tinggi */
